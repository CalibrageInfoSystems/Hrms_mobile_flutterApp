...
class ChangePasword extends StatefulWidget {
  ...
  final String userid;
  const ChangePasword({super.key, required this.newpassword, required this.confirmpassword, required this.userid});
  @override
...
class _changepasswordState extends State<ChangePasword> {
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(top: 35.0, left: 90.0, right: 90.0),
                        child: Material(
                          color: Colors.white,
                          borderRadius: BorderRadius.circular(6.0),
                          // Adjust the border radius as needed
                          elevation: 4.0, // Add elevation for a subtle shadow effect
                          shadowColor: Colors.grey, // Customize the shadow color if needed
                          child: Container(
                            height: 35,
                            width: double.infinity,
                            decoration: BoxDecoration(
                            ...
                            child: ElevatedButton(
                              ...
                              child: const Text(
                                'Back to Sign In',
                                style: TextStyle(
                                  color: Color(0xFFf15f22), // Change text color to contrast with white background
                                  fontSize: 16,
                                  fontFamily: 'Calibri',
                                ),
                              ),
  ...
  Future<void> textvalidate() async {
    ...
    if (isValid && password1.trim() == password2.trim()) {
      ...
      //   _confirmpasswordcontroller.clear(); // Clear the text in the TextEditingController
      // });
      Commonutils.showCustomToastMessageLong("Passwords Doesn't Match", context, 1, 4);
    }
