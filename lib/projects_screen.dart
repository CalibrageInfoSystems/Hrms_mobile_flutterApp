...
class projects_screen extends StatefulWidget {
  const projects_screen({super.key});
          ...
          children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      DateFormat('dd MMM yyyy')
                          .format(fromDate), // Format date here
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(4, 7, 5, 0),
                    child: Text(
                              ...
                              text: TextSpan(
                                children: <InlineSpan>[
                                  const WidgetSpan(
                                    child: SizedBox(
                                      width:
                                          83, // Adjust the width as needed to align the colons
                                  ...
                                  WidgetSpan(
                                    child: Container(
                                      // Adjust the width as needed to align the colons
                                      child: Text(' ${member['employeeCode']}',
                                          style: const TextStyle(
                                              color: Colors.black)),
                                    ),
                                  ),
